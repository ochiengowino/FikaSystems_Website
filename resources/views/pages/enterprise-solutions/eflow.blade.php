        ...
        <div class="row g-5 mb-5">
            ...
            <div class="col-lg-6  wow zoomIn" data-wow-delay="0.9s" style="min-height: 200px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/office11.jpeg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-0 wow fadeInUp mb-5" data-wow-delay="0.1s" style="background: #f8f9fa">
    <div class="container py-0">
        <div class="row g-5">  
            <div class="col-lg-6  wow zoomIn mb-5" data-wow-delay="0.9s" style="min-height: 350px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/office45.jpg" style="object-fit: cover;">
                </div>
            </div>         
            <div class="col-lg-6">
                <div class="row g-5">
                    <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                        <h3>Why Customers Choose eFlow</h3>
                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i>Increases efficiency</h5> 
                        <p class="mb-3">Capture data up to 80% faster, cutting your operating costs and making it easier to manage information.</p>
                        
                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i>Maintains compliance</h5> 
                        <p class="mb-3">Data is managed and stored to facilitate compliance with internal policies, industry regulations and legal requirements.</p>

                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i>Empowers employees</h5> 
                        <p class="mb-3">With workflow and process improvements, employees are more efficient and focused on valuable tasks.</p>

                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i>Upgrades process capabilities</h5> 
                        <p class="mb-3">Improve your ability to handle business processes involving invoices, purchase orders, forms and mailroom classification.</p>
                    </div>
                </div>
            </div> 
        </div>
