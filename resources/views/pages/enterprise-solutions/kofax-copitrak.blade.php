        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6  wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/printing30.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="row g-5">
                    ...
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.6s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/office24.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
                    ...
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/office27.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
                    ...
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/office23.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
                    ...
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.3s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/office16.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
