        ...
        <div class="row g-5 mb-5">
            ...
            <div class="col-lg-6  wow zoomIn" data-wow-delay="0.9s" style="min-height: 200px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/office51.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row g-5">
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/erp15.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
                    ...
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.6s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/printing36.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
                    ...
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/erp2.jpg" alt="" style="width: 100%; height: 250px">
                            </div>
                            <div class="p-4">
    ...
    <div class="container py-0">
        <div class="row g-5">
            <div class="col-lg-6  wow zoomIn mb-3" data-wow-delay="0.9s" style="min-height: 350px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/office3.jpg" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row g-5">
                    <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                        <h3>eCopy Suite of Solutions</h3>
                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i> eCopy ShareScan</h5> 
                        <p class="mb-3">The modular and scalable platform architecture gives you the freedom to build the right solution. Select components or choose from packaged solutions—all of which can be managed within one integrated system.</p>
                        
                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i>Kofax eCopy Email and Folder Watching Service</h5> 
                        <p class="mb-3">Through monitoring of network folders and email addresses, you can extend eCopy capture workflows to electronic documents, files and images from virtually any source.</p>

                        <h5 class="mb-1"><i class="fa fa-check text-primary me-3"></i>Kofax eCopy Connectors and Extenders</h5> 
                        <p class="mb-3">By adding connectors, you can store and organize documents in external repositories. Extenders transform documents and integrate external data.</p>
